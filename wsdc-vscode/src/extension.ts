...
export function activate(context: vscode.ExtensionContext) {
    ...
    const explainCommand = vscode.commands.registerCommand('wsdc.explainFinding', async (diagnostic: vscode.Diagnostic, document: vscode.TextDocument) => {
...
function runSlither(document: vscode.TextDocument) {
    ...
    const slitherPath = config.get<string>('slitherPath') || 'slither';
...
function mapSlitherToDiagnostics(document: vscode.TextDocument, detectors: any[]) {
...
function getVscodeSeverity(slitherImpact: string): vscode.DiagnosticSeverity {
...
export class WsdcCodeActionProvider implements vscode.CodeActionProvider {
...
async function explainFindingWithAI(diagnostic: vscode.Diagnostic, document: vscode.TextDocument) {
    const config = vscode.workspace.getConfiguration('wsdc');
